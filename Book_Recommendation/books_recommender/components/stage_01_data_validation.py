...
class DataValidation:
    ...
    def preprocess_data(self):
        try: 
            ...
            # Here Image URL is important for the poster so, we will keep it. 
            ...
            # Lets store users who had atleast rated more than 200 books 
            ...
            # Lets take those books which have more than 50 ratings 
            ...
            # Saving the clean data for transformation 
            os.makedirs(self.data_validation_config.clean_data_dir, exist_ok=True)
            final_rating.to_csv(self.data_validation_config.clean_data_dir + '/final_clean_data.csv', index=False)
            logging.info(f"Saved cleaned data to {self.data_validation_config.clean_data_dir}")
            
            # Saving final rating for web app 
    ...
    def initiate_data_validation(self):
        try:
            logging.info(logging.info(f"{'='*20}Data Validation log started.{'='*20} "))
